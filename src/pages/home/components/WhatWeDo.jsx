...
const WhatWeDo = () => {
  ...
  return (
    <div className="lg:px-[100px] px-[20px] mt-[90px] flex flex-col items-center">
      <div className="lg:w-[768px] pb-[17px]">
        <h6 className="font-[500] text-[24px] leading-[32.4px] text-center text-[#DBDBDB]">
          What we do
        </h6>
        <h4 className="text-white mt-[8px] font-[700] text-[20px] lg:text-[40px] leading-[54px] text-center">
          Empowering tech talents globally and helping startups.
        </h4>
      </div>
      <div className="">
        {/* what we do */}
        <div className="flex max-lg:flex-col lg:gap-x-[20px] ">
          {whatWeDo?.map((item, index)=>(
            <div key={index} className="flex flex-col gap-y-[28px] bg-[#181818] border-[1px] border-[#292929] pb-[43px] rounded-[12px] lastpt-[36px]">
               <div className="flex flex-col gap-y-[28px] bg-[#181818] border-[1px] border-[#292929] px-[24px] pb-[56px] rounded-[12px] lg:last:pt-[36px] h-[350px]">
        ...
        {/* Entry for Cohort */}
        <div className=" bg-[#181818] w-full flex max-lg:flex-col max-lg:gap-y-[60px] justify-center lg:gap-x-[160px] py-[60px] items-center mt-[8px]" >
          ...
          <Button className={"h-fit px-[27px] w-full lg:w-[213px]"}>Fill entry form</Button>
        </div>
      </div>
    </div>
  );
