          ...
          {slides?.map((slide, index) => (
            ...
            >
              <div
                className={`${
                  index == 1 && "bg-[#00404B]"
                } flex items-center lg:mt-[114px] font-satoshi max-lg:px-[36px] max-lg:pr-[44px]  lg:px-[130px]`}
              >
                <div>
                  <h3 className="text-[16px] lg:text-[72px] font-[900] leading-[97.2px] lg:leading-[97.2x] tracking-[1%] text-white">
                    {slide.title}
                  </h3>
                  <p className="text-[10px] lg:pr-[105px] max-lg:text-justify lg:text-[22px] lg:w-[715px] font-[400] leading-[18.08px] lg:leading-[35px] text-justify text-[#E3E3E3]">
                    {slide.desc}
                  </p>
                ...
                <img src={slide.image} className=" lg:size-[407px]" />
              </div>
