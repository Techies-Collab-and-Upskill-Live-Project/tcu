...
const About = () => {
  return (
    <div className='bg-[#121212] text-[#ffffff] w-full h-full px-[20px] md:px-[50px]'> {/* Combined padding classes */}
      <div className='flex flex-col md:flex-row gap-[20px]'>
        <div className='w-full md:w-[578px] h-[318px] md:h-[529px]'>
            <img src={us} alt='us' className='rounded-[16px] w-full h-full object-cover'/> {/* Ensured image covers container */}
        </div>
      ...
      <div className='flex flex-col items-center pt-[50px]'>
        <p>Our Partners</p>
        <div className='flex flex-wrap justify-center gap-[1rem] md:gap-[5rem] pt-[15px]'> {/* Changed to flex-wrap and justify-center */}
            {[...Array(7)].map((_, i) => (
              <div key={i}>
