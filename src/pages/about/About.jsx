  ...
  const reviews = [
    {
      ...
      role: "Project Manager",
      feedback:
        "As one of the project managers in TCU 1,0, Working with designers and developers was a profound experience I hope to have again. We were able to seamlessly integrate a functional, user friendly platform.",
      socials: linkedin,
    },
    {
      avatar: temitayo,
      ...
      feedback:
        "While leading the design team to create the Donation Trace platform, it was an interesting experience and process. Working with the developers to bring our project to life was challenging, yet beautiful.",
      socials: twitter,
    },
    {
      avatar: simon,
      ...
      role: "Developer",
      feedback:
        "Working with others, has been a highly rewarding experience. The team’s dedication to excellence, innovative approach to problem-solving, and collaborative spirit have made the project both challenging and fulfilling.",
      socials: linkedin,
    },
    {
      avatar: light,
      ...
      feedback:
        "Collaborating with designers and developers  was an impactful experience. Through proper communication, we were able to integrate aesthetics and functionality, in creating a user-friendly platform.",
      socials: twitter,
    },
  ];
    ...
    <div className="bg-[#121212] text-[#ffffff] w-full h-full px-[20px] md:px-[50px] font-satoshi">
      <div className="flex flex-col md:flex-row gap-[20px]">
        ...
        <div className="w-full md:w-[620px] h-full">
          ...
          <p className="text-[19px] md:text-[50px] font-[700]">
            Where creativity meets opportunity
          </p>
          <p className="text-[11px] md:text-[18px] pt-[20px]">
            We are a community built by individuals with diverse levels of
            experience in technology, spanning from entry-level to mid and
            senior positions join forces to collaborate and enhance their skill
            sets and build their personal portfolio. We also have a seasoned
            team specializing in technological service solutions.
          </p>
          <p className="text-[11px] md:text-[18px] pt-[20px]">
            Our team of experienced developers and designers are at the
            forefront of technological advancement. We leverage the latest tools
            and frameworks to craft robust, scalable solutions that address
            real-world challenges. From web and mobile applications to complex
            enterprise systems, we deliver results that empower our clients and
            shape the future.
          </p>
          <div className="flex gap-[20px] pt-[20px]">
            <div>
              <p className="text-[19px] md:text-[32px] font-[700] md:font-[900]">
                8+
              </p>
      ...
      <div>
        <p className="text-[11px] md:text-[18px] pt-[20px] md:pt-[80px]">
          We believe everyone deserves the opportunity to participate in the
          exciting world of technology. Our unique platform provides a
          collaborative learning environment for aspiring developers, designers,
          and other tech enthusiasts. Here, you'll gain practical experience
          working alongside industry professionals on real-world projects. It's
          not just learning the ropes, it's contributing to cutting-edge
          solutions while building your skillset and portfolio.
        </p>
        <p className="text-[11px] md:text-[18px] pt-[20px]">
          At TCU, we foster a collaborative spirit. Our experienced team mentors
          newcomers, while fresh perspectives inject new ideas into the
          development process. This synergy fuels innovation and allows us to
          create truly groundbreaking tech solutions.
        </p>

        <div className="flex float-right">
          <img src={wireclay} alt="wireclay" />
        </div>
      </div>
      ...
      <div className="flex">
        <img src={spiralclay} alt="spiralclay" />
      </div>
              ...
              <SwiperSlide key={index}>
                <div className="flex flex-col items-center">
                  ...
                  <div className="bg-[#181818] md:w-[260px] w-[260px] md:h-[150px] h-[140px] mt-[-12px] rounded-b-[12px] flex flex-col justify-center items-center">
                    <p className="md:text-[20px] text-[16px] font-[700] text-center">
                      {member.name}
                    </p>
                    <p className="md:text-[14px] text-[12px] font-[400] w-[180px] text-center">
                      {member.role}
                    </p>
                    <div className="flex gap-[1.5rem] pt-[20px] items-center">
                      <IoLogoLinkedin className="w-[20px] h-[20px]" />
        ...
        <div className="block lg:hidden">
          ...
          <div className="flex justify-center items-center">
            <button
              ...
              className="mt-[20px] flex justify-center items-center w-[59px] h-[36px] bg-white text-black rounded-[21.84px]"
            >
      ...
      <div className="flex flex-col items-center pt-[50px] pb-[30px]">
        ...
        <p className="text-[20px] font-[700] md:text-[48px]">
      ...
      <div className="grid md:grid-cols-4 grid-cols-2 gap-[1rem] items-center justify-center">
        {reviews &&
          reviews.map((review, index) => (
            <div
              key={index}
              className="border border-[#191919] border-t-[#121212] border-b-[#121212] w-[165px] h-[250px] md:w-[280px] md:h-[304px] md:pl-[15px] pl-[8px]"
            >
              <div className="flex gap-[1rem] pt-[20px]">
                <img src={review.avatar} alt="avatar" />
                <div>
                  <p className="md:text-[16px] text-[12px] font-[700]">
                    {review.name}
                  </p>
                  <p className="md:text-[12px] text-[10px] font-[400]">
                    {review.role}
                  </p>
                </div>
              </div>
              <div className="md:w-[253px] w-[160]  ">
                <p className="md:text-[14px] text-[10px] font-[500] pt-[20px]">
                  {review.feedback}
                </p>
              </div>
