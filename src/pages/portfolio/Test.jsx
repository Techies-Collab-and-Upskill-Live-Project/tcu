...
import portfolio1 from "../../assets/portfolio1.png"
import portfolio2 from "../../assets/portfolio2.png"
// import portfolio1 from "./Assets/Charity.png"
// import portfolio2 from "./Assets/HealthBenefit.png"
import { PiArrowCircleDownLight } from "react-icons/pi";
import Button from "../../components/Button";

const Test = () => {
  return (
    <div className="max-lg:w-full border border-emerald-500 px-[20px] lg:px-[100px] flex flex-col mt-[51.67px] lg:mt-[50px]">
