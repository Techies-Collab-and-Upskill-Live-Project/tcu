    ...
    >
      <div className={twMerge(`flex flex-col lg:w-[401px] `, descClass)}>
        ...
        <p className="text-[#D9D9D9] text-[14px] lg:text-[16px] leading-[18.9px] lg:leading-[21.6px] font-[400] mt-[10px]">
          We have a seasoned team that cares for your startup more than you do.
          You wont believe until you try.
        </p>
      </div>
      <form
        className={twMerge(
      ...
      >
        ...
        />
        <Button className="w-full bg-[#fff] rounded-[4px] mt-[20px] text-[#121212] font-[700] text-[7.74px] lg:text-[15px] lg:leading-[24px] leading-[12.39px]">
          Send Message
        </Button>
      </form>
    </div>
